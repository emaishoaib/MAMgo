...
public class IndexerV1
{
	...
	{	
		String state_txt = "C:\\Users\\emais\\workspace\\Crawler\\Crawled\\state.txt";
		String links_txt = "C:\\Users\\emais\\workspace\\Crawler\\Crawled\\links.txt";
		String htmls_folder = "C:\\Users\\emais\\workspace\\Crawler\\Crawled\\HTMLs\\";
		...
		try
		{
			...
			while (stateNum - lastID != 1)
			{
				...
				//Storing the doc's ID and link in database
